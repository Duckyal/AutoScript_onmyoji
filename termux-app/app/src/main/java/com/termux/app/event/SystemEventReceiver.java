...
public class SystemEventReceiver extends BroadcastReceiver {
    ...
    public synchronized static void registerPackageUpdateEvents(@NonNull Context context) {
        ...
        // dynamically registered receivers. This receiver only listens for system
        // package broadcasts, so RECEIVER_NOT_EXPORTED prevents other apps from
        // sending forged broadcasts. System broadcasts are still delivered.
        // Note: 3-arg registerReceiver() exists since API 26; on API < 33 the flags are ignored.
        context.registerReceiver(getInstance(), intentFilter, Context.RECEIVER_NOT_EXPORTED);
    }
